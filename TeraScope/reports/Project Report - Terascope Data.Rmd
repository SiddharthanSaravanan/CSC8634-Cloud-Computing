...
```{r, echo=FALSE, figures-side4, fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot_6
plot_7
```

```{r, echo=FALSE, figures-side5, fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot_8
plot_9
```
...
```{r, echo=FALSE, figures-side6, fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot_10
plot_11
```

```{r, echo=FALSE, figures-side7, fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot_12
plot_13
```
...
```{r, echo=FALSE, figures-side8, fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot_15
plot_16
```

```{r, echo=FALSE, figures-side9, fig.show="hold", out.width="50%"}
par(mar = c(4, 4, .1, .1))
plot_17
plot_18
```
